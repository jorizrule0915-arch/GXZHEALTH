  ...
  const values = [
    {
      ...
      title: "Precision",
      description:
        "Every product crafted for consistent, reliable results that support your wellness goals.",
    },
    {
      icon: Shield,
      title: "Quality",
      description:
        "Rigorous quality control ensures our products meet the highest standards of performance.",
    },
    {
      icon: Users,
      title: "Support",
      description:
        "Comprehensive guides and responsive customer service for every customer.",
    },
    {
      icon: Award,
      title: "Trust",
      description:
        "Trusted by wellness enthusiasts worldwide for premium, reliable products.",
    },
  ];
  ...
  const offerings = [
    {
      ...
      description:
        "Science-backed formulations designed to boost strength, endurance, and hydration.",
    },
    {
      icon: Heart,
      title: "Body Care Products",
      description:
        "Premium body care essentials crafted to nourish, restore, and support daily wellness.",
    },
    {
      icon: Beaker,
      title: "Wellness Accessories",
      description:
        "High-quality tools and accessories built for precision and everyday performance.",
    },
    {
      icon: Truck,
      title: "Fast & Discreet Shipping",
      description:
        "Quick delivery straight to your door, so you never miss a step in your routine.",
    },
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/80 leading-relaxed">
              GXZ Peptides provides premium wellness supplements and body care
              products designed to support precision, consistency, and everyday
              performance. Our commitment to quality helps you feel and perform
              at your best.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  GXZ Peptides was founded with a clear mission: to provide
                  individuals with high-quality wellness products that deliver
                  real results. We believe that feeling strong, recovered, and
                  energized every day shouldn't be complicated.
                </p>
                <p>
                  Our product line includes performance supplements, nourishing
                  body care essentials, and precision wellness accessories. Each
                  product is formulated and crafted to meet the demands of an
                  active, health-conscious lifestyle.
                </p>
                <p>
                  We also provide comprehensive usage guides to ensure every
                  customer — whether new to wellness products or experienced —
                  gets the most out of every GXZ Peptides product from day one.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              From performance supplements to body care essentials, we provide
              everything you need to support your strength, recovery, and daily
              wellness.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-white/80 text-lg mb-8">
              Explore our product catalog or learn how to get the most out of
              every GXZ Peptides product with our comprehensive guides.
            </p>
