      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 text-white py-20 pt-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            At GXZ Peptides, we stand behind the quality of our products and
            strive to ensure every customer has a positive experience.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          <p className="text-slate-700 text-lg leading-relaxed">
            At GXZ Peptides, we stand behind the quality of our products and
            strive to ensure every customer has a positive experience. Please
            review the policy below regarding refunds, returns, and exchanges.
          </p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-6">
            <p className="text-slate-700 mb-6 leading-relaxed">
              Due to the nature of health, wellness, and personal care products,
              returns are generally not accepted once an item has been opened or
              used.
            </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            <p className="text-slate-700 mb-6">
              The following items cannot be returned for safety and hygiene
              reasons:
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-3 p-4 bg-rose-50 rounded-lg border border-rose-100"
                >
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-r from-slate-900 to-teal-900 rounded-2xl p-8 text-white">
            ...
            <p className="text-slate-300 leading-relaxed">
              Orders may be canceled before they are shipped. Once an order has
              been shipped, it cannot be canceled.
            </p>
          </div>
        </section>
